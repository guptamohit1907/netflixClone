...
let episode1 = Episode(name: "Beginnings and Endings", season: 1, episodeNumber: 1, thumbnailImageURLString: "https://picsum.photos/300/102", description: "Six months after the disappereances, the police form a task force In 2052, Jones learns the most of Winden Perished in an apocalyptic event.", length: 53, videoURL: exampleVideoURL)

let episode2 = Episode(name: "Dark Matter", season: 1, episodeNumber: 2, thumbnailImageURLString: "https://picsum.photos/300/103", description: "Clausen and Charlotte interview Regina. The Stronger takes Hannah to 1987 where Claudia has unerving encounter and Egon visits an old nemesis.", length: 54, videoURL: exampleVideoURL)

let episode3 = Episode(name: "Ghosts", season: 1, episodeNumber: 3, thumbnailImageURLString: "https://picsum.photos/300/104", description: "In 1954 a missing Heldge return , but he will only speak to Noah. In 1987 Caludia brings the time machine to Tannhaus , and Egon questions Ulrich again.", length: 53, videoURL: exampleVideoURL)

let episode4 = Episode(name: "Beginnings and Endings", season: 2, episodeNumber: 1, thumbnailImageURLString: "https://picsum.photos/300/107", description: "Six months after the disappereances, the police form a task force In 2052, Jones learns the most of Winden Perished in an apocalyptic event.", length: 53, videoURL: exampleVideoURL)
...
let episode6 = Episode(name: "Ghosts", season: 2, episodeNumber: 3, thumbnailImageURLString: "https://picsum.photos/300/105", description: "In 1954 a missing Heldge return , but he will only speak to Noah. In 1987 Caludia brings the time machine to Tannhaus , and Egon questions Ulrich again.", length: 53, videoURL: exampleVideoURL)
...
let exampleMovie5 = Movie(
    ...
    cast : "Louis Hoffman Oliver Masucci , jordis Triebel",
    moreLikeThisMovies: [],
    trailers: exampleTrailers, previewImageName: "dirtyJohnPreview"
    ,previewVideoURL: exampleVideoURL
    )
let exampleMovie6 = Movie(
    ...
    trailers: exampleTrailers, previewImageName: "travelersPreview"
    ,previewVideoURL: exampleVideoURL
)
...
let exampleMovie7 = Movie(
    ...
    cast : "Louis Hoffman Oliver Masucci , jordis Triebel",
    moreLikeThisMovies: [],
    promotionHeadline: "Watch Season 6 Now", trailers: exampleTrailers, previewImageName: "travelersPreview"
    ,previewVideoURL: exampleVideoURL
)
...
let exampleEpisodeInfo1 = CurrentEpisodeInfo(episodeName: "Beginnings and Endings", description: "Six months after the disappereances, the police form a task force In 2052, Jones learns the most of Winden Perished in an apocalyptic event. ", season: 2, episode: 1)
